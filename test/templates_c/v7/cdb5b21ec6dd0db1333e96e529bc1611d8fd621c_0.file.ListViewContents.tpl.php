...
/* Smarty version 4.5.4, created on 2024-10-18 19:18:42
  from '/home1/rxgenumy/public_html/mycrm/layouts/v7/modules/Vtiger/ListViewContents.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_6712b492a9c473_00358586',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cdb5b21ec6dd0db1333e96e529bc1611d8fd621c' => 
    array (
      0 => '/home1/rxgenumy/public_html/mycrm/layouts/v7/modules/Vtiger/ListViewContents.tpl',
      1 => 1727651112,
      2 => 'file',
    ),
  ),
...
function content_6712b492a9c473_00358586 (Smarty_Internal_Template $_smarty_tpl) {
...
" id='pageLimit'>
	<input type="hidden" name="noOfEntries" value="<?php echo (isset($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value)) ? $_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value : '';?>
" id="noOfEntries">
	<input type="hidden" name="currentSearchParams" value="<?php echo (isset($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value)) ? Vtiger_Util_Helper::toSafeHTML(Zend_JSON::encode($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value)) : '';?>
" id="currentSearchParams" />
        <input type="hidden" name="currentTagParams" value="<?php echo (isset($_smarty_tpl->tpl_vars['TAG_DETAILS']->value)) ? Vtiger_Util_Helper::toSafeHTML(Zend_JSON::encode($_smarty_tpl->tpl_vars['TAG_DETAILS']->value)) : '';?>
" id="currentTagParams" />
	<input type="hidden" name="noFilterCache" value="<?php echo (isset($_smarty_tpl->tpl_vars['NO_SEARCH_PARAMS_CACHE']->value)) ? $_smarty_tpl->tpl_vars['NO_SEARCH_PARAMS_CACHE']->value : '';?>
" id="noFilterCache" >
	<input type="hidden" name="orderBy" value="<?php echo (isset($_smarty_tpl->tpl_vars['ORDER_BY']->value)) ? $_smarty_tpl->tpl_vars['ORDER_BY']->value : '';?>
" id="orderBy">
	<input type="hidden" name="sortOrder" value="<?php echo (isset($_smarty_tpl->tpl_vars['SORT_ORDER']->value)) ? $_smarty_tpl->tpl_vars['SORT_ORDER']->value : '';?>
" id="sortOrder">
	<input type="hidden" name="list_headers" value='<?php echo (isset($_smarty_tpl->tpl_vars['LIST_HEADER_FIELDS']->value)) ? $_smarty_tpl->tpl_vars['LIST_HEADER_FIELDS']->value : '';?>
'/>
...
' />
	...
	<?php if (!$_smarty_tpl->tpl_vars['SEARCH_MODE_RESULTS']->value) {?>
		<?php $_smarty_tpl->_subTemplateRender(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtemplate_path' ][ 0 ], array( "ListViewActions.tpl",$_smarty_tpl->tpl_vars['MODULE']->value )), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
	<?php }?>

	<div id="table-content" class="table-container">
		<form name='list' id='listedit' action='' onsubmit="return false;">
			<table id="listview-table" class="table <?php if ((isset($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value)) && $_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value == '0') {?>listview-table-norecords <?php }?> listview-table ">
				<thead>
...
?>
					...
					<?php }?>
					<th <?php if ((isset($_smarty_tpl->tpl_vars['COLUMN_NAME']->value)) && $_smarty_tpl->tpl_vars['COLUMN_NAME']->value == $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name')) {?> nowrap="nowrap" <?php }?>>
...
&nbsp;
						...
						<?php if ((isset($_smarty_tpl->tpl_vars['COLUMN_NAME']->value)) && $_smarty_tpl->tpl_vars['COLUMN_NAME']->value == $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name')) {?>
...
'<?php }?>>
							<td class = "listViewRecordActions">
								<?php $_smarty_tpl->_subTemplateRender(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtemplate_path' ][ 0 ], array( "ListViewRecordActions.tpl",$_smarty_tpl->tpl_vars['MODULE']->value )), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
							</td>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
				<?php if ((isset($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value)) && $_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value == '0') {?>
