<?php
/* Smarty version 4.5.4, created on 2024-10-19 09:30:53
  from '/home1/rxgenumy/public_html/mycrm/layouts/v7/modules/Settings/LayoutEditor/FieldCreate.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_67137c4d58dc37_53313183',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6b62c10fb89638577e52018ec2a2e0ef2067c306' => 
    array (
      0 => '/home1/rxgenumy/public_html/mycrm/layouts/v7/modules/Settings/LayoutEditor/FieldCreate.tpl',
      1 => 1727651112,
      2 => 'file',
    ),
  ),
...
function content_67137c4d58dc37_53313183 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
" /><input type="hidden" name="addToBaseTable" value="<?php echo (isset($_smarty_tpl->tpl_vars['ADD_TO_BASE_TABLE']->value)) ? $_smarty_tpl->tpl_vars['ADD_TO_BASE_TABLE']->value : '';?>
" /><input type="hidden" name="_source" value="<?php echo (isset($_smarty_tpl->tpl_vars['SOURCE']->value)) ? $_smarty_tpl->tpl_vars['SOURCE']->value : '';?>
...
&nbsp;<span class="redColor">*</span></label><div class="controls col-sm-7"><select class="col-sm-6 relationModule" name="relationmodule[]" multiple data-rule-required='true'><?php if ((isset($_smarty_tpl->tpl_vars['FIELD_TYPE_INFO']->value['Relation']))) {
...
if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isActiveOptionDisabled()) {?> optionDisabled = "true" readonly="readonly" <?php }?> <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory()) {?> readonly="readonly" <?php }?>data-on-text="Yes" data-off-text="No" value="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('presence');?>
...
if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isHeaderFieldOptionDisabled() || (isset($_smarty_tpl->tpl_vars['IS_NAME_FIELD']->value)) && $_smarty_tpl->tpl_vars['IS_NAME_FIELD']->value) {?>readonly="readonly"<?php }?> /></label></div></div></div><div class="row"><div class="form-group col-sm-7"><label class="control-label fieldLabel col-sm-10"><img src="<?php echo vimage_path('MassEdit.png');?>
...
if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMassEditOptionDisabled()) {?>readonly="readonly"<?php }?>/></label></div></div></div></div></div></div><?php $_smarty_tpl->_subTemplateRender(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtemplate_path' ][ 0 ], array( 'ModalFooter.tpl','Vtiger' )), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
