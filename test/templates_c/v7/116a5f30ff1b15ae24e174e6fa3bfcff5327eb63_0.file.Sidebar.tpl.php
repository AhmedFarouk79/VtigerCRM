<?php
/* Smarty version 4.5.4, created on 2024-10-18 19:19:05
  from '/home1/rxgenumy/public_html/mycrm/layouts/v7/modules/Settings/Vtiger/Sidebar.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_6712b4a9597456_78788920',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '116a5f30ff1b15ae24e174e6fa3bfcff5327eb63' => 
    array (
      0 => '/home1/rxgenumy/public_html/mycrm/layouts/v7/modules/Settings/Vtiger/Sidebar.tpl',
      1 => 1727651112,
      2 => 'file',
    ),
  ),
...
function content_6712b4a9597456_78788920 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_assignInScope('NUM_OF_MENU_ITEMS', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'php7_sizeof' ][ 0 ], array( $_smarty_tpl->tpl_vars['BLOCK_MENU_ITEMS']->value )));
...
"><i class="indicator fa<?php if ((isset($_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['block'])) && $_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['block'] == $_smarty_tpl->tpl_vars['BLOCK_NAME']->value) {?> fa-chevron-down <?php } else { ?> fa-chevron-right <?php }?>"></i>&nbsp;<span><?php echo vtranslate($_smarty_tpl->tpl_vars['BLOCK_NAME']->value,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></a></div></div></div><div id="<?php echo $_smarty_tpl->tpl_vars['BLOCK_NAME']->value;?>
" class="panel-collapse collapse ulBlock <?php if ((isset($_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['block'])) && $_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['block'] == $_smarty_tpl->tpl_vars['BLOCK_NAME']->value) {?> in <?php }?>"><ul class="list-group widgetContainer"><?php
...
" class="menuItemLabel <?php if ((isset($_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['menu'])) && $_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['menu'] == $_smarty_tpl->tpl_vars['MENU']->value) {?> settingsgroup-menu-color <?php }?>"><?php echo vtranslate($_smarty_tpl->tpl_vars['MENU_LABEL']->value,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
