<?php
/* Smarty version 4.5.4, created on 2024-10-18 19:52:42
  from '/home1/rxgenumy/public_html/mycrm/layouts/v7/modules/Settings/Vtiger/ListViewContents.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_6712bc8a5daf14_13221248',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6be7ceaf9282ce487998d65a9f62c4183217e67d' => 
    array (
      0 => '/home1/rxgenumy/public_html/mycrm/layouts/v7/modules/Settings/Vtiger/ListViewContents.tpl',
      1 => 1727651112,
      2 => 'file',
    ),
  ),
...
function content_6712bc8a5daf14_13221248 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
" /><input type="hidden" value="<?php echo (isset($_smarty_tpl->tpl_vars['ORDER_BY']->value)) ? $_smarty_tpl->tpl_vars['ORDER_BY']->value : '';?>
" id="orderBy"><input type="hidden" value="<?php echo (isset($_smarty_tpl->tpl_vars['SORT_ORDER']->value)) ? $_smarty_tpl->tpl_vars['SORT_ORDER']->value : '';?>
" id="sortOrder"><input type="hidden" id="totalCount" value="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_COUNT']->value;?>
" /><input type='hidden' value="<?php echo (isset($_smarty_tpl->tpl_vars['PAGE_NUMBER']->value)) ? $_smarty_tpl->tpl_vars['PAGE_NUMBER']->value : '';?>
" id='pageNumber'><input type='hidden' value="<?php echo $_smarty_tpl->tpl_vars['PAGING_MODEL']->value->getPageLimit();?>
" id='pageLimit'><input type="hidden" value="<?php echo (isset($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value)) ? $_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value : '';?>
...
if ((isset($_smarty_tpl->tpl_vars['SHOW_LISTVIEW_CHECKBOX']->value)) && $_smarty_tpl->tpl_vars['SHOW_LISTVIEW_CHECKBOX']->value == true) {?><th><span class="input"><input class="listViewEntriesMainCheckBox" type="checkbox"></span></th><?php }
}
if ($_smarty_tpl->tpl_vars['MODULE']->value == 'Tags' || $_smarty_tpl->tpl_vars['MODULE']->value == 'CronTasks' || (isset($_smarty_tpl->tpl_vars['LISTVIEW_ACTIONS_ENABLED']->value)) && $_smarty_tpl->tpl_vars['LISTVIEW_ACTIONS_ENABLED']->value == true) {?><th><?php echo vtranslate('LBL_ACTIONS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</th><?php }
...
?><th nowrap><a <?php if (!($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->has('sort'))) {?> class="listViewHeaderValues cursorPointer" data-nextsortorderval="<?php if ((isset($_smarty_tpl->tpl_vars['COLUMN_NAME']->value)) && $_smarty_tpl->tpl_vars['COLUMN_NAME']->value == $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name')) {
...
&nbsp;<?php if ((isset($_smarty_tpl->tpl_vars['COLUMN_NAME']->value)) && $_smarty_tpl->tpl_vars['COLUMN_NAME']->value == $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name')) {?><img class="<?php echo $_smarty_tpl->tpl_vars['SORT_IMAGE']->value;?>
...
"<?php }?>><td width="10%"><?php $_smarty_tpl->_subTemplateRender(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtemplate_path' ][ 0 ], array( "ListViewRecordActions.tpl",$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value )), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?></td><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['LISTVIEW_HEADERS']->value, 'LISTVIEW_HEADER', true);
$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->iteration = 0;
$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->do_else = true;
...
" width="<?php echo (isset($_smarty_tpl->tpl_vars['WIDTH']->value)) ? $_smarty_tpl->tpl_vars['WIDTH']->value : '';?>
...
if ((isset($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value)) && $_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value == '0') {?><tr class="emptyRecordsDiv"><?php ob_start();
